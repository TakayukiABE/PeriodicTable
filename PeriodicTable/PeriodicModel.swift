...
class PeriodicModel: NSObject {
    ...
    override init() {
        ...
        var B:Element = Element(symbol: "B", name: "ホウ素", number: 5, massNumber: 10.81, state: "個体", meltingPoint: 2077, boilingPoint: 3870, ionization: 800.6, affinity: 27, orbit: "K2L3", category: "典型半金属元素")
        var C:Element = Element(symbol: "C", name: "炭素", number: 6, massNumber: 12.011, state: "個体", meltingPoint: 9999, boilingPoint: 3370, ionization: 1086.5, affinity: 122, orbit: "K2L4", category: "典型非金属元素")
        var N:Element = Element(symbol: "N", name: "窒素", number: 7, massNumber: 14.007, state: "気体", meltingPoint: -210, boilingPoint: -196, ionization: 1402.3, affinity: -8, orbit: "K2L5", category: "典型非金属元素")
        var O:Element = Element(symbol: "O", name: "酸素", number: 8, massNumber: 15.999, state: "気体", meltingPoint: -218, boilingPoint: -183, ionization: 1313.9, affinity: 141, orbit: "K2L6", category: "典型非金属元素")
        ...
        var Al:Element = Element(symbol: "Al", name: "アルミニウム", number: 13, massNumber: 26.981, state: "個体", meltingPoint: 660, boilingPoint: 2520, ionization: 577.5, affinity: 43, orbit: "K2L8M3", category: "典型金属元素")
        var Si:Element = Element(symbol: "Si", name: "ケイ素", number: 14, massNumber: 28.085, state: "個体", meltingPoint: 1412, boilingPoint: 3266, ionization: 786.5, affinity: 134, orbit: "K2L8M4", category: "典型半金属元素")
        var P:Element = Element(symbol: "P", name: "リン", number: 15, massNumber: 30.973, state: "個体", meltingPoint: 590, boilingPoint: 430, ionization: 1011.8, affinity: 72, orbit: "K2L8M5", category: "典型非金属元素")
        var S:Element = Element(symbol: "S", name: "硫黄", number: 16, massNumber: 32.06, state: "個体", meltingPoint: 113, boilingPoint: 445, ionization: 999.6, affinity: 200, orbit: "K2L8M6", category: "典型非金属元素")
        ...
        var Sc:Element = Element(symbol: "Sc", name: "スカンジウム", number: 21, massNumber: 44.955, state: "個体", meltingPoint: 1539, boilingPoint: 2831, ionization: 633.1, affinity: 18, orbit: "K2L8M9N2", category: "遷移元素")
        ...
        var Ga = Element(symbol: "Ga", name: "ガリウム", number: 31, massNumber: 69.723, state: "個体", meltingPoint: 30, boilingPoint: 2208, ionization: 578.8, affinity: 41, orbit: "K2L8M18N3", category: "典型金属元素")
        var Ge = Element(symbol: "Ge", name: "ゲルマニウム", number: 32, massNumber: 72.63, state: "個体", meltingPoint: 937, boilingPoint: 2834, ionization: 762, affinity: 119, orbit: "K2L8M18N4", category: "典型半金属元素")
        var As = Element(symbol: "As", name: "ヒ素", number: 33, massNumber: 74.921, state: "固定", meltingPoint: 817, boilingPoint: 603, ionization: 947.0, affinity: 79, orbit: "K2L8M18N5", category: "典型半金属元素")
        var Se = Element(symbol: "Se", name: "セレン", number: 34, massNumber: 78.971, state: "固定", meltingPoint: 220, boilingPoint: 685, ionization: 941.0, affinity: 195, orbit: "K2L8M18N6", category: "典型非金属元素")
        ...
        var In = Element(symbol: "In", name: "インジウム", number: 49, massNumber: 114.818, state: "", meltingPoint: 157, boilingPoint: 2072, ionization: 558.3, affinity: 39, orbit: "K2L8M18N18O3", category: "典型金属元素")
        var Sn = Element(symbol: "Sn", name: "スズ", number: 50, massNumber: 118.710, state: "", meltingPoint: 232, boilingPoint: 2603, ionization: 708.6, affinity: 107, orbit: "K2L8M18N18O4", category: "典型金属元素")
        var Sb = Element(symbol: "Sb", name: "アンチモン", number: 51, massNumber: 121.760, state: "", meltingPoint: 631, boilingPoint: 1587, ionization: 834, affinity: 101, orbit: "K2L8M18N18O5", category: "典型半金属元素")
        var Te = Element(symbol: "Te", name: "テルル", number: 52, massNumber: 127.60, state: "", meltingPoint: 450, boilingPoint: 991, ionization: 869.3, affinity: 190, orbit: "K2L8M18N18O6", category: "典型半金属元素")
        ...
        var Tl = Element(symbol: "Tl", name: "タリウム", number: 81, massNumber: 204.38, state: "", meltingPoint: 304, boilingPoint: 1473, ionization: 589.4, affinity: 36, orbit: "K2L8M18N31O18P3", category: "典型金属元素")
        var Pb = Element(symbol: "Pb", name: "鉛", number: 82, massNumber: 207.2, state: "", meltingPoint: 328, boilingPoint: 1750, ionization: 715.6, affinity: 35, orbit: "K2L8M18N31O18P4", category: "典型金属元素")
        var Bi = Element(symbol: "Bi", name: "ビスマス", number: 83, massNumber: 208.980, state: "", meltingPoint: 271, boilingPoint: 1561, ionization: 703, affinity: 91, orbit: "K2L8M18N31O18P5", category: "典型金属元素")
        var Po = Element(symbol: "Po", name: "ポロニウム", number: 84, massNumber: 209, state: "", meltingPoint: 254, boilingPoint: 962, ionization: 812.1, affinity: 183, orbit: "K2L8M18N31O18P6", category: "典型半金属元素")
